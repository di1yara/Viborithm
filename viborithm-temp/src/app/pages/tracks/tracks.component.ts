...
export class TracksComponent implements OnInit {
  ...
  addTrack() {
    if (!this.newTrack.title || !this.newTrack.artist) {
      this.error = 'Title and artist are required'; return;
    }
    this.loading = true;
    this.error = '';
    ...
    if (this.newTrack.genre_id) {
      formData.append('genre_id', this.newTrack.genre_id.toString());
    }
