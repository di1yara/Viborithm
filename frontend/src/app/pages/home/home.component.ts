...
export class HomeComponent implements OnInit {
  ...
  prev() {
    this.activeIndex = (this.activeIndex - 1 + this.featuredTracks.length) % this.featuredTracks.length;
  }

  next() {
    this.activeIndex = (this.activeIndex + 1) % this.featuredTracks.length;
  }
